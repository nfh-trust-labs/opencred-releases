...
var init_config = __esm({
  "../shared/dist/config.js"() {
    z.object({
      ...
      DEDI_API_TIMEOUT_MS: z.coerce.number().int().positive().default(1e4),
      ...
      // Session / state
      SESSION_TTL_MS: z.coerce.number().int().positive().default(4 * 60 * 60 * 1e3),
      // 4 hours
      SESSION_SWEEP_INTERVAL_MS: z.coerce.number().int().positive().default(60 * 1e3),
      // 60 seconds
      // Auth / JWT
      ...
      // Batch processing
      MAX_BATCH_SIZE: z.coerce.number().int().positive().default(1e3),
      // CSCA Trust Store
